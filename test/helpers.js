...
function loadFrontend(){
  ...
  vm.runInContext(src + `
    this.api = {
      ...
      teachFor, termCredit, kinOnCard, kinCensus, bandLabel, westernWord, wordSplits, teknonym, matchesName, houseName, houseOf, waysToAdd, parentBySex, branchFrom, startBuild, closeBuild, draw, setShape, setReach,
