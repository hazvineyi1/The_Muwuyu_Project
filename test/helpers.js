...
function loadFrontend(){
  ...
  vm.runInContext(src + `
    this.api = {
      ...
      teachFor, termCredit, kinOnCard, kinCensus, bandLabel, westernWord, wordSplits, teknonym, matchesName, houseName, houseOf, waysToAdd, parentBySex, branchFrom, startBuild, closeBuild, cutPeople, joinsIn, toggleFold, unfoldAll, houseNameFor, draw,
      ...
      setAside, restore, deleteForever, noticesFor, asidePeople, present, mergePeople, meName,
