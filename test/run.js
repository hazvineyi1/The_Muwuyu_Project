...
const FILES = ['gate.test.js', 'access.test.js', 'chosen.test.js', 'keeper.test.js', 'admin.test.js', 'hardening.test.js', 'ops.test.js', 'deleting.test.js', 'concurrency.test.js', 'reads.test.js',
               'duplicates.test.js', 'parity.test.js', 'sides.test.js', 'joining.test.js', 'joined.test.js', 'oneside.test.js', 'carrying.test.js', 'rows.test.js', 'kinship.test.js', 'naming.test.js', 'halfsiblings.test.js', 'mothersline.test.js', 'cousins.test.js', 'houses.test.js', 'totems.test.js', 'palettes.test.js',
