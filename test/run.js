...
const FILES = ['gate.test.js', 'access.test.js', 'chosen.test.js', 'keeper.test.js', 'admin.test.js', 'hardening.test.js', 'ops.test.js', 'deleting.test.js', 'concurrency.test.js', 'reads.test.js',
               'duplicates.test.js', 'parity.test.js', 'sides.test.js', 'joining.test.js', 'finding.test.js', 'joined.test.js', 'oneside.test.js', 'carrying.test.js', 'rows.test.js', 'kinship.test.js', 'glossary.test.js', 'shape.test.js', 'marriedin.test.js', 'whyhere.test.js', 'naming.test.js', 'words.test.js', 'called.test.js', 'adding.test.js', 'building.test.js', 'halfsiblings.test.js', 'mothersline.test.js', 'cousins.test.js', 'houses.test.js', 'totems.test.js', 'palettes.test.js',
