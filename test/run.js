...
const FILES = ['gate.test.js', 'access.test.js', 'chosen.test.js', 'admin.test.js', 'hardening.test.js', 'ops.test.js', 'concurrency.test.js', 'reads.test.js',
               'duplicates.test.js', 'parity.test.js', 'sides.test.js', 'kinship.test.js', 'halfsiblings.test.js', 'mothersline.test.js', 'cousins.test.js', 'houses.test.js', 'totems.test.js', 'palettes.test.js',
